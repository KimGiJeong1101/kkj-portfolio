...
const AboutMe = () => {
  ...
  return (
    <section id="aboutme" className="min-h-[60vh] flex items-center justify-center py-20">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                안녕하세요! 저는 복잡한 문제를 단순하게 푸는 것을 즐깁니다. <br />
                사용자 중심의 사고로 더 나은 경험을 설계합니다.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div>
                  <p className="text-sm text-slate-400 uppercase tracking-wider font-semibold">NAME</p>
            ...
            <div className="bg-indigo-100 h-64 rounded-2xl flex items-center justify-center">
              {/* 여기에 본인 사진이나 일러스트 배치 */}
              <span className="text-indigo-400 font-mono italic">Your Profile Image</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
